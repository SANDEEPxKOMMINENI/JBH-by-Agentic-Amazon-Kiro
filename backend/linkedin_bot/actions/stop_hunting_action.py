#!/usr/bin/env python3
"""
Stop Hunting Action for LinkedIn Bot
"""
...
class StopHuntingAction(BaseAction):
    """Action to stop the LinkedIn hunting process"""
    ...
    def execute(self) -> Dict[str, Any]:
        """
        Stop the LinkedIn hunting process, close browser, and eliminate bot
        """
        try:
            self.logger.info(f"Stopping LinkedIn bot {self.bot.bot_id}")
            ...
            self.logger.info(f"LinkedIn bot {self.bot.bot_id} stopped and eliminated")

            return {
                "success": True,
                "message": "LinkedIn bot stopped and browser eliminated",
                "status": "stopped",
            }

        except Exception as e:
            self.logger.error(f"Failed to stop LinkedIn bot: {e}")
