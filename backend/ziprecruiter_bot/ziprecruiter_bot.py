#!/usr/bin/env python3
"""
Simple ZipRecruiter Bot for JobHuntr v2
@file purpose: Simple ZipRecruiter automation using BrowserOperator with integrated WebSocket communication
"""
...
from ziprecruiter_bot.actions import (
...
class ZipRecruiterBot:
    """
    Simple ZipRecruiter Bot that automates ZipRecruiter job search and queue
    ...
    def start_searching(self) -> Dict[str, Any]:
        """Start the ZipRecruiter searching process using StartSearchingAction"""
        action = StartSearchingAction(self)
        return action.execute()

    def stop_searching(self) -> Dict[str, Any]:
        """Stop the ZipRecruiter searching process using StopSearchingAction"""
...
if __name__ == "__main__":
    ...
    def test_bot():
        ...
        bot = ZipRecruiterBot("test_bot", "test_user", websocket_callback=test_callback)
