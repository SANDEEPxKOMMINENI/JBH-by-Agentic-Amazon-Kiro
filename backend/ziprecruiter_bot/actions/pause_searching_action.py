#!/usr/bin/env python3
"""
Pause Searching Action for ZipRecruiter Bot
"""
...
class PauseSearchingAction(BaseAction):
    """Action to pause the ZipRecruiter searching process"""
    ...
    def execute(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(
                f"ZipRecruiter bot {self.bot.bot_id} and browser operations paused"
            )
