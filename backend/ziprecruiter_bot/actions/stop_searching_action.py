#!/usr/bin/env python3
"""
Stop Searching Action for ZipRecruiter Bot
"""
...
class StopSearchingAction(BaseAction):
    """Action to stop the ZipRecruiter searching process"""
    ...
    def execute(self) -> Dict[str, Any]:
        """
        Stop the ZipRecruiter searching process, close browser, and eliminate bot
        """
        try:
            self.logger.info(f"Stopping ZipRecruiter bot {self.bot.bot_id}")
            ...
            self.logger.info(
                f"ZipRecruiter bot {self.bot.bot_id} stopped and eliminated"
            )

            return {
                "success": True,
                "message": "ZipRecruiter bot stopped and browser eliminated",
                "status": "stopped",
            }

        except Exception as e:
            self.logger.error(f"Failed to stop ZipRecruiter bot: {e}")
