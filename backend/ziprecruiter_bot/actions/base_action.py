#!/usr/bin/env python3
"""
Base Action class for ZipRecruiter Bot actions
"""
...
class BaseAction(ABC):
    """
    Base class for all ZipRecruiter Bot actions
    ...
    def __init__(self, bot_instance):
        ...
        Args:
            bot_instance: The ZipRecruiterBot instance this action operates on
        """
