#!/usr/bin/env python3
"""
Simple Glassdoor Bot for JobHuntr v2
@file purpose: Simple Glassdoor automation using BrowserOperator with integrated WebSocket communication
"""
...
from glassdoor_bot.actions import (
...
class GlassdoorBot:
    """
    Simple Glassdoor Bot that automates Glassdoor job search and queue
    ...
    def start_searching(self) -> Dict[str, Any]:
        """Start the Glassdoor searching process using StartSearchingAction"""
        action = StartSearchingAction(self)
        return action.execute()

    def stop_searching(self) -> Dict[str, Any]:
        """Stop the Glassdoor searching process using StopSearchingAction"""
...
if __name__ == "__main__":
    ...
    def test_bot():
        ...
        bot = GlassdoorBot("test_bot", "test_user", websocket_callback=test_callback)
