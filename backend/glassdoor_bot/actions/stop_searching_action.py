#!/usr/bin/env python3
"""
Stop Searching Action for Glassdoor Bot
"""
...
class StopSearchingAction(BaseAction):
    """Action to stop the Glassdoor searching process"""
    ...
    def execute(self) -> Dict[str, Any]:
        """
        Stop the Glassdoor searching process, close browser, and eliminate bot
        """
        try:
            self.logger.info(f"Stopping Glassdoor bot {self.bot.bot_id}")
            ...
            self.logger.info(f"Glassdoor bot {self.bot.bot_id} stopped and eliminated")

            return {
                "success": True,
                "message": "Glassdoor bot stopped and browser eliminated",
                "status": "stopped",
            }

        except Exception as e:
            self.logger.error(f"Failed to stop Glassdoor bot: {e}")
