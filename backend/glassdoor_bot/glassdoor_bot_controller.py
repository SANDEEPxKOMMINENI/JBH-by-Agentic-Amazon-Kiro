#!/usr/bin/env python3
"""
Glassdoor Bot Controller for JobHuntr v2
@file purpose: Manage Glassdoor bot instances and WebSocket communication
"""
...
class GlassdoorBotController:
    """Controller to manage Glassdoor bot instances and activity polling"""

    def __init__(self):
        self.bots: Dict[str, GlassdoorBot] = {}
    ...
    def start_searching_controller(
        ...
        try:
            ...
            bot_id = f"glassdoor_bot_{workflow_run_id}_{uuid.uuid4().hex[:8]}"
            bot = GlassdoorBot(
                bot_id,
                user_id,
            ...
            logger.info(
                f"Created new Glassdoor bot for workflow run {workflow_run_id}: {bot_id}"
            )
...
glassdoor_bot_controller = GlassdoorBotController()
